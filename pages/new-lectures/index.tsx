...
import { useGetNewLectures, useGetNewProducts } from "../../query/new_quries";
import { newproductsList } from "../../components/tanstackTable/columns/newproductsList";
import { newlectures } from "../../components/tanstackTable/columns/newlectures";
...
export default function NewLectures() {
  ...
  const { data: lecturesData } = useGetNewLectures();
  const data = useMemo(() => lecturesData || [], [lecturesData]);
  const columns = useMemo<ColumnDef<any, any>[]>(() => newlectures, []);
